        ...
        <CardBody className="space-y-4">
          ...
          {calculating && (
            <div className="flex items-center gap-2">
              <Spinner size="sm" />
              <span>
                Calculando... (verifique o console do servidor para logs)
              </span>
            </div>
          )}
                ...
                <div className="space-y-4">
                  <div className="bg-blue-50 border-2 border-blue-500 p-4 rounded-lg">
                    ...
                    <p className="text-sm mt-1">
                      <strong>Peso:</strong>{" "}
                      {shippingResult.packageInfo?.weight}kg
                      {" | "}
                  ...
                  {shippingResult.shippingOptions?.map(
                        ...
                        <div className="flex justify-between items-start">
                          ...
                          <div className="text-right">
                            <p className="text-2xl font-bold text-green-600">
                              R${" "}
                              {option.valor ? option.valor.toFixed(2) : "N/A"}
                            </p>
                          </div>
                        </div>
                      </div>
      ...
      <Card>
        ...
        <CardBody>
          <ol className="list-decimal list-inside space-y-2 text-sm">
            <li>
              <strong>Verifique a configuração</strong> - Certifique-se que o
            ...
            <li>
              <strong>Verifique os logs do servidor</strong> - No terminal onde
              o Next.js está rodando, procure por:
