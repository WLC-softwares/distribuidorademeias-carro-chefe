        ...
        async function loadRelatedProducts(currentProduct: Product) {
            try {
                ...
                let related = allProducts.filter(
                    (p) => p.categoria === currentProduct.categoria &&
                ...
                if (related.length === 0) {
                    related = allProducts.filter(
                        (p) => p.id !== currentProduct.id && p.ativo && p.status === 'ATIVO'
                    );
                }
                ...
                <div className="fixed top-20 right-4 z-50 animate-in slide-in-from-right">
                    <Card className="bg-green-50 border-2 border-green-600">
                        <CardBody className="flex flex-row items-center gap-3 p-4">
                            ...
                            <div>
                                <p className="font-semibold text-green-900">Produto adicionado!</p>
                            ...
                            <CardBody className="p-6 space-y-4">
                                ...
                                <div className="flex items-center gap-2 flex-wrap">
                                    <Chip
                                        size="sm"
                                        variant="solid"
                                        className={`font-semibold ${tipoVenda === 'atacado'
                                ...
                                <div className="border-t border-gray-200 pt-4">
                                    <p className="text-sm text-gray-600 mb-3">Selecione o tipo de compra:</p>
                                    ...
                                    <div className="border-t border-gray-200 pt-4">
                                        ...
                                        {quantidade > 1 && (
                                            <p className="text-sm text-gray-600 mt-2">
                                                Total: <span className="font-semibold">R$ {precoTotal.toFixed(2)}</span>
                                            </p>
                                        )}
                                    </div>
                                )}
                                ...
                                <div className="space-y-2 pt-4">
                                    {temEstoque ? (
                                        ...
                                        <Chip color="danger" variant="flat" className="w-full justify-center py-6">
