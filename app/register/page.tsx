                        ...
                        <CardBody className="gap-6 p-8">
                            ...
                            <div className="mb-2">
                                ...
                                <div className="mt-4 flex gap-2">
                                    <div className={`h-1 flex-1 rounded-full ${registerHook.step === 'personal' || registerHook.step === 'document' || registerHook.step === 'address' ? 'bg-purple-600' : 'bg-gray-200'}`} />
                                    <div className={`h-1 flex-1 rounded-full ${registerHook.step === 'document' || registerHook.step === 'address' ? 'bg-purple-600' : 'bg-gray-200'}`} />
                                    <div className={`h-1 flex-1 rounded-full ${registerHook.step === 'address' ? 'bg-purple-600' : 'bg-gray-200'}`} />
                                </div>
                            </div>
                            ...
                            {registerHook.step === 'personal' && (
                                <PersonalInfoStep
                                    ...
                                    isConfirmPasswordVisible={registerHook.isConfirmPasswordVisible}
                                    updateFormData={registerHook.updateFormData}
                                    onSubmit={registerHook.handlePersonalInfoNext}
                                    onTogglePasswordVisibility={registerHook.togglePasswordVisibility}
                                    onToggleConfirmPasswordVisibility={registerHook.toggleConfirmPasswordVisibility}
                                />
                            )}
