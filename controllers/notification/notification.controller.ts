 ...
 */
export async function getUnreadNotificationsAction(usuarioId: string): Promise<Notification[]> {
    try {
 ...
 */
export async function countUnreadNotificationsAction(usuarioId: string): Promise<number> {
    try {
 ...
 */
export async function markAllNotificationsAsReadAction(usuarioId: string): Promise<void> {
    try {
 ...
 */
export async function deleteAllReadNotificationsAction(usuarioId: string): Promise<void> {
    try {
