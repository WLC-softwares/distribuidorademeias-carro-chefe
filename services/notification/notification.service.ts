...
export class NotificationService {
    ...
    async createOrderStatusNotification(
        ...
        const statusMessages: Record<string, { tipo: NotificationType; titulo: string; mensagem: string; emoji: string }> = {
            PROCESSANDO: {
     ...
     */
    async getUserNotifications(usuarioId: string, limit?: number): Promise<Notification[]> {
