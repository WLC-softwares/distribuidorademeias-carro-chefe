        ...
        try {
            ...
            try {
                ...
                if (usuario) {
                    ...
                    const emailHtml = generateOrderConfirmationEmail(usuario.nome, venda.numeroVenda, {
                        ...
                        paymentMethod: formaPagamentoMap[venda.formaPagamento] || venda.formaPagamento,
                    });
            ...
            if (vendaAtual && oldStatus !== status) {
                ...
                try {
                    ...
                    if (usuario) {
                        ...
                        const { generateOrderStatusUpdateEmail } = await import('@/lib/email');
